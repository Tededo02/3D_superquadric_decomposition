...
def main(argv: list[str] | None = None) -> int:
    ...
    colors: np.ndarray = []
    # TODO: pipeline    
    test = SuperQuadricParams(1.2,1.2,0.7,0.5,0.5,[2,2,1],[5,5,5])
    ...
    sampled_points = np.vstack([*sampled_points_noisy,*sampled_points_random]) # concatenate all sampled points and outliers into a single (N, 3) array. * is the unpacking operator to unpack the list of arrays into individual arrays for vstack
